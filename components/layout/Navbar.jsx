          ...
          <div className="flex items-center justify-end gap-3.5">
            <form onSubmit={handleSearchSubmit} className="hidden md:block relative">
              ...
              <input
                ...
                className="bg-white/[0.05] border border-white/10 rounded-full py-2 pr-4 text-sm text-white focus:outline-none focus:border-[#2563eb]/60 focus:bg-white/[0.08] transition-all w-52 lg:w-60 placeholder:text-[#64748b] font-sans"
              />
            </form>
            <button
              type="button"
              className="hidden md:block px-5 py-2 bg-white hover:bg-white/85 text-black font-semibold text-sm rounded-full transition-colors flex-shrink-0"
            >
              Sign In
            </button>
            <div
